...
1. **[Neon Bonk] Musique** — boucle synthwave procédurale (basse arpégée, batterie), intensité selon le danger.
2. **[Star Forge] Équilibrage** — simulation d'un joueur optimal : 1re Supernova visée à ~15–20 min ; option de notation scientifique.
3. **[Bloc Party] Défi du jour** — graine quotidienne identique pour tout le monde, meilleur score du jour.
4. **[Transverse] PWA** — manifest + icône pour installer Playtoon sur l'écran d'accueil mobile.
5. **[Neon Bonk] Équilibrage minutes 2–5** — le bot « humain » (fuite + ramassage, choix au hasard) meurt entre 2:30 et 9:00 selon les runs, v1 comme aujourd'hui : mesurer sur 20 runs et adoucir la montée (brutes, taux d'apparition) sans rendre la fin triviale.
