...
const DICT = {
  ...
  fr: {
    ...
    'bp.hudLevel': 'NIVEAU {n} · COUPS', 'bp.hudDaily': '🎯 DÉFI DU JOUR', 'bp.hudGoal': 'OBJECTIF', 'bp.hudDailyBest': 'MEILLEUR DU JOUR', 'bp.hudTime': '⏱ TEMPS', 'bp.hudScoreRec': 'SCORE · RECORD {n}',
  ...
  es: {
    ...
    'bp.hudLevel': 'NIVEL {n} · MOVIMIENTOS', 'bp.hudDaily': '🎯 RETO DIARIO', 'bp.hudGoal': 'OBJETIVO', 'bp.hudDailyBest': 'MEJOR DE HOY', 'bp.hudTime': '⏱ TIEMPO', 'bp.hudScoreRec': 'PUNTOS · RÉCORD {n}',
  ...
  it: {
    ...
    'bp.hudLevel': 'LIVELLO {n} · MOSSE', 'bp.hudDaily': '🎯 SFIDA DEL GIORNO', 'bp.hudGoal': 'OBIETTIVO', 'bp.hudDailyBest': 'RECORD DI OGGI', 'bp.hudTime': '⏱ TEMPO', 'bp.hudScoreRec': 'PUNTI · RECORD {n}',
  ...
  pt: {
    ...
    'bp.hudLevel': 'NÍVEL {n} · JOGADAS', 'bp.hudDaily': '🎯 DESAFIO DIÁRIO', 'bp.hudGoal': 'OBJETIVO', 'bp.hudDailyBest': 'RECORDE DE HOJE', 'bp.hudTime': '⏱ TEMPO', 'bp.hudScoreRec': 'PONTOS · RECORDE {n}',
